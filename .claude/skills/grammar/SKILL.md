...
- Tests and probes that read `screen.md` must give the design's facts (`DESIGN_SAYS` in fixtures.ts, or `designSays(rng)`), else the rules take pictures off every screen.
