...
export const GATES = {
  hue: { again: ["hue"], label: "another accent color?", q: "Does the message ask for a different accent colour, or object to the one there is?", yes: "It names a colour, or says the present colour is wrong.", no: "It says nothing about which colour the accent is. Lighter, darker, brighter or duller are not a different colour." },
